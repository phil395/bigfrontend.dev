[https://bigfrontend.dev/problem/implement-general-memoization-function](https://bigfrontend.dev/problem/implement-general-memoization-function)
...
The arguments are arbitrary, so memo should accept an extra resolver parameter, which is used to generate the cache key, like what [.memoize()](https://lodash.com/docs/4.17.15#memoize) does.
